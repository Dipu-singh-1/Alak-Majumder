...
"use client"; // Ensure that this is at the top to signify client-side rendering
import Image from "next/image";
import { Card, CardContent } from "@/components/ui/card";
import Link from "next/link";
import Marquee from "@/components/Marquee";
              ...
              <div className="md:w-1/2 text-black ">
                ...
                <div className="max-w-4xl mx-auto">
                  <p className="text-gray-700 leading-relaxed mb-4">
                    <span className="bg-gray-200 text-pink-500 px-1 rounded">
                      Dr. Alak Majumder
                    </span>{" "} is a tenure track Assistant Professor in the Department of
                    Electronics and Communication Engineering (ECE) at{" "}
                    <span className="bg-gray-200 text-pink-500 px-1 rounded">
                      National Institute of Technology (NIT), Arunachal Pradesh,
                      India
                    ...
                    <span className="bg-gray-200 text-pink-500 px-1 rounded">
                      Integrated Circuit & System (i-CAS) Lab
                    </span>{" "} founded in 2015. He holds a{" "}
                    <span className="bg-gray-200 text-pink-500 px-1 rounded">
                      Ph.D (Engg) in ECE
                    </span>{" "} from NIT Arunachal Pradesh, where he carried out research on{" "}
                    <span className="bg-gray-200 text-pink-500 px-1 rounded">
                    &quot;High Speed Data Links&quot;
                    </span>{" "} under the supervision of{" "}
                    <span className="bg-gray-200 text-pink-500 px-1 rounded">
                      Prof. (Dr) Bidyut K Bhattacharyya (Fellow IEEE)
                    </span>{" "} and{" "}
                    <span className="bg-gray-200 text-pink-500 px-1 rounded">
                      Dr. P. Chakraborty
                    </span>. Earlier, he earned BE in Electronics and Telecommunication
                    Engineering from{" "}
                    <span className="bg-gray-200 text-pink-500 px-1 rounded">
                      Tripura Institute of Technology, Agartala, India
                    </span>{" "} and{" "}
                    <span className="bg-gray-200 text-pink-500 px-1 rounded">
                      M-Tech in Microelectronics and VLSI Design
                    </span>{" "} from National Institute of Technology, Agartala, India. He
                    serves as a reviewer of many journals / transactions of{" "}
                    <Link
                      href="https://www.ieee.org/"
                      className="bg-gray-200 text-pink-500 px-1 rounded"
                ...
                <div className="max-w-4xl mx-auto">
                  ...
                  <p className="text-gray-700 leading-relaxed mb-4">
                    He is also serving / served as an organizing member / reviewer of many international conferences of repute.{" "}
                    <span className="bg-gray-200 text-pink-500 px-1 rounded">
                      Dr. Majumder received &quot;Best Research/Paper Award&quot;
                    </span>{" "} from{" "}
                    <span className="bg-gray-200 text-pink-500 px-1 rounded">
                    ...
                    <span className="bg-gray-200 text-pink-500 px-1 rounded">
                      ICEIC-2017, Phuket
                    </span>. He is a member of{" "}
                    <Link
                      href="https://www.ieee.org/"
                      className="bg-gray-200 text-pink-500 px-1 rounded"
                    >
                      IEEE
                    </Link>. Although his interests span almost all major aspects of{" "}
                    <span className="bg-gray-200 text-pink-500 px-1 rounded">
                      VLSI Circuits and Systems
                    </span>.
                  </p>
                ...
                <CardContent className="p-6 flex items-center justify-between">
                  <h3 className="text-lg font-semibold mb-2 text-black  flex  gap-4">
                    ...
                    >
                      <path
                        fillRule="evenodd"
                        d="M10 3a7 7 0 1 1 0 14 7 7 0 0 1 0-14zm0 2a5 5 0 1 0 0 10 5 5 0 0 0 0-10z"
                        clipRule="evenodd"
                      />
                    </svg>{" "}
                    Analog IC design
